...
class UpdateProfile extends Component{
    ...
    handleSubmit(){
        this.database.child(this.currentUser.uid).set({username: this.state.username}).then(() =>{
            this.currentUser.updateProfile({displayName: this.state.username, photoURL: this.state.picture})
